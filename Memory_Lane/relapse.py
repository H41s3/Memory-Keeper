...
class Relapse:
    ...
    def play_function(self):
        while True:
            y = input("Type 'yes' to know more about Rhei, 'no' to skip: ").strip().lower()
            if y == 'yes':
                return (f"{self.name} is my Gwen Stacy in this world. I still remember everything about her, "
                        f"such as her favorite color, {self.favorite_color}.")
            elif y == 'no':
                return "Alright, skipping..."
            else:
